  ...
  var json = [
    {
      ...
      arr: [
        [
          { value: 10, color: "rgba(104, 104, 249, 0.8)" },
          { value: 10, color: "rgb(104 104 249 / 0.4)" },
          { value: 3,  description:' ', color: "rgb(215 209 255)" },
        ],

        [
          { value: 10, color: "rgba(104, 104, 249, 0.8)" },
          { value: 5, color: "rgb(104 104 249 / 0.4)" },
          { value: 3,  description:' ', color: "rgb(215 209 255)" },
        ],
        [
          { value: 10, color: "rgb(104 104 249 / 0.8)" },
          { value: 5, color: "rgb(104 104 249 / 0.4)" },
          { value: 3,  description:' ', color: "rgb(215 209 255)" },
        ],
        [
          { value: 10, color: "rgb(201, 150, 235)" },
          { value: 5, color: "rgb(201 150 235 / 0.6)" },
          { value: 3, color: "rgb(201 150 235 / 0.3)" },
          { value: 3,  description:' ', color: "rgb(215 209 255)" },
        ],
        240,
      ],
