  ...
  return (
    <div className="product-userjourney-card">
      <div className="product-userjourney-card-heading-and-icon">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#808080" class="bi bi-info-circle " viewBox="0 0 16 16">
      ...
      <p className="product-userjourney-card-number">{data[1]}</p>
      <p className={data[2] > 0 ? ('pluse-value'):('minuse-value') }>{data[2] > 0 ? (data[2]+'% ↑'):(data[2]+'% ↓')}</p>
      ...
      <div className="my-pluse-minus-buttons">
        {classed !== "my-minuse-button" && (
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-plus-circle  my-button"
            viewBox="0 0 16 16"
        ...
        {classed === "my-minuse-button" && (
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-dash-circle  my-button"
            viewBox="0 0 16 16"
...
export default ProductUserJourney;
