            ...
            <div className="product-discovery-pos-stickey-syn" style={{ "display": "flex", "flexDirection": "column" }}>
               ...
               <div className="product-discovery-indicators-syn">
                    ...
                    <div className="product-all-indicators-with-icons-syn">
                        <label>
                            <svg style={{marginRight:'10px', marginLeft: '20px'}} width="14" height="14" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <label>
                            <svg style={{marginRight:'8px', marginLeft: '20px'}} width="14" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <label>
                            <svg style={{marginRight:'8px', marginLeft: '20px'}} width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <label>
                            <svg style={{marginRight:'8px', marginLeft: '20px'}} width="14" height="14" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <label>
                            <svg style={{marginRight:'8px', marginLeft: '20px'}} width="14" height="14" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <label>
                        <svg style={{marginRight:'8px', marginLeft: '20px'}} width="14" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <label>
                        <svg style={{marginRight:'8px', marginLeft: '20px'}} width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        ...
                        <div className="product-discovery-carousal-and-page-rails-syn">
                            <div className="product-discovery-carousal-syn">
                                <h6 className="product-discovery-carousal-heading-syn">Carousal</h6>
                            ...
                            <div className="product-discovery-page-rails-syn">
                                <h6 className="product-discovery-page-rails-heading-syn">Page Rails</h6>
                                <div className="product-discovery-carousal-two-pi-syn">
                                    <div className="product-discovery-carousal-pi-chart-one-syn">
                                        <h6>Home Page</h6>
